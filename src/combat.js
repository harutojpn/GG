...
function buildShared() {
  ...
  M = {
    gobSkin: toonMaterial(0x9d5233, { flatShading: true }),
    gobDark: toonMaterial(0x7c3f28, { flatShading: true }),
    cloth: toonMaterial(0xb59a54, { flatShading: true, side: THREE.DoubleSide }),
    wood: toonMaterial(0x775230, { flatShading: true }),
    eyeY: glowMaterial(0xffd23e, 1.6),
    bone: toonMaterial(0xe8e2d0, { flatShading: true }),
    blade: toonMaterial(0xb9c3cf, { flatShading: true }),
    grip: toonMaterial(0x4e3b28, { flatShading: true }),
    ...
    stone: toonMaterial(0x8a8577, { flatShading: true }),
    flameO: glowMaterial(0xff8a2a, 1.7),
    flameI: glowMaterial(0xffd76a, 2.2),
    tent: toonMaterial(0x8a6242, { flatShading: true }),
